...
for filename, line_name in [('static/ompStatic1/ompStatic1.out', 'static-1(N)'),
                            ('static/ompStatic2/ompStatic2.out', 'static-2(N)'),
                            ('static/ompStatic4/ompStatic4.out', 'static-4(N)'),
                            ('static/ompStatic8/ompStatic8.out', 'static-8(N)'),
                            ]:
