...
for filename, line_name in [('dynamic/ompDynamic1/ompDynamic1.out', 'dynamic-1(N)'),
                            ('dynamic/ompDynamic2/ompDynamic2.out', 'dynamic-2(N)'),
                            ('dynamic/ompDynamic4/ompDynamic4.out', 'dynamic-4(N)'),
                            ('dynamic/ompDynamic8/ompDynamic8.out', 'dynamic-8(N)'),
                            ]:
